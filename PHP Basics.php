...
Display the value of each variable and the total variable when you add them together. -->
    <script>
		$yourName = 'Robert McDOnell'; /* created variable and assigned my name */
		
		$number1 = 1;
		$number2 = 2;
		$total = $number1 + $number2; /* created 3 variables and assigned numeric value
...
<body>
    <h1>PHP Basics</h1>   
	<p> Name: <?php echo "<h1> Name:$yourName </h1> ";$yourName; ?></p>
	<p>Variables: <?php echo $number1 '+' $number2 '=' $total;
